 ...
 * @version 2.0
 */
public abstract class Clothes extends Product implements Serializable {

    private Size size;
    private Color color;

    public Clothes(double price, String title, LocalDate issueDate, Size size, Color color) {
